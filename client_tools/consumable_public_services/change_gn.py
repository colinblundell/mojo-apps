...
[r'(LICENSE file.)', r'\1\n\nimport("//build/config/mojo.gni")', ['mojo/services/public*BUILD.gn']],
[r'"//(mojo/public[^"]*")', r'rebase_path("\1, ".", mojo_root)', ['mojo/services/public*BUILD.gn']],
#[r'([ ]+)(sources =.*)', r'\1public_configs = [ "../../../build/config:services" ]\n\n\1\2', ['mojo/services/public/*BUILD.gn']],

...
#[r'(LICENSE file.)', r'\1\n\nimport("//build/config/mojo.gni")', ['mojo/public*BUILD.gn', 'mojo/edk*BUILD.gn', 'mojo/services/public*BUILD.gn', "*mojom.gni", "*mojo_application.gni"]],
# Adding the public config.
[r'([ ]+)(sources =.*)', r'\1public_configs = [ "mojo/build/config:mojo_sdk" ]\n\1\2', ['mojo/public*BUILD.gn']],
